...
{
    /// <summary>View Model for presenting an <see cref="AdverbPhraseBuilder"/> in a PropertyGrid</summary>
    public class AdverbPhraseProperties : ParentProperties
    {
        internal AdverbPhraseProperties(AdverbPhraseBuilder apb) : base(apb) { Model = apb; }

        private AdverbPhraseBuilder Model;
