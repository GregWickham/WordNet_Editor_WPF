...
{
    /// <summary>View Model for presenting a <see cref="VerbPhraseBuilder"/> in a PropertyGrid</summary>
    public class VerbPhraseProperties : ParentProperties
    {
        internal VerbPhraseProperties(VerbPhraseBuilder vpb) : base(vpb) { Model = vpb; }

        private VerbPhraseBuilder Model;
