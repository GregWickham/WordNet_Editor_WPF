...
{
    /// <summary>View Model for presenting an <see cref="IndependentClauseBuilder"/> in a PropertyGrid</summary>
    public class IndependentClauseProperties : ParentProperties
    {
        internal IndependentClauseProperties(IndependentClauseBuilder icb) : base(icb) { Model = icb; }

        private IndependentClauseBuilder Model;
